...
// Warning: This returns a pointer ot a static internal buffer, so the next call will overwrite it.
...
extern inline bool is_token_name(const char *name) {
...
void lex_test() {
    char *str = "XY+(XY)_HELLO1,234+994";
    init_stream(str);
